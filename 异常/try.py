...
# try:
#     # print(aaa)
#     files = open('bbb.txt', 'r', encoding='utf-8')  # 如果这句话有错，就会捕获到异常
...
'''
    练习
     ...
     在这种情况下，当你尝试将输入转换为整数时，ValueError 异常。编写一个程序，
     提示用户输入两个数字，再将它们相加并打印结果。
     在用户输入的任何一个值不是数字时都捕获ValueError 异常，并打印一条友好的错误消息。
