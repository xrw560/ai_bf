...
SAVE_PATH = 'model/init10/mymodel'
...
class Init:
    ...
    def train(self, epoches=5000):
        ...
        file_writer = tf.summary.FileWriter('log10', graph=self.graph)
        step = 0
